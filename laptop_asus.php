...
<html lang="de">
<head>
	<title>Laptop Asus - LapTopCDC</title>
	...
	<div class="nd">
		<div class="container">
			<div class="laptop_new clearfix">
				...
				<div class="nd_right">
					<h1><strong>LAPTOP ASUS</strong></h1>
                    <?php 

                        $products = $get_data -> se_product_asus();
                    ?>
					<div class="new_laptop clearfix">
						...
						<div class="laptop_new1">
							<a href="product_detail.php?id=<?php echo $pro['MASP'] ?>"><img src="img/SANPHAM/ASUS/<?php echo $pro['HINHANH'] ?>"></a>
