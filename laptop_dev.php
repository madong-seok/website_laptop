...
<html lang="de">
<head>
	<title>Laptop Lập trình viên - LapTopCDC</title>
	...
	<div class="nd">
		<div class="container">
			<div class="laptop_new clearfix">
				...
				<div class="nd_right">
					<h1><strong>LAPTOP LẬP TRÌNH VIÊN</strong></h1>
                    <?php 

                        $products = $get_data -> se_product_dev();
                    ?>
			...
			<div class="end-left clearfix">
					...
					<div class="end-left-2">
						...
						<ul>
							...
							<li><a href="register.phpp">Tài Khoản Giao Dịch</a></li>
						</ul>
					</div>
				</div>
