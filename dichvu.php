				...
				<div class="row">
					<div class="banner">
						...
						<ul class="header-top pull-right" style="list-style-type:none;">
							<li class="lienhe"><a href="register.phpp">Đăng ký</a></li>
							<li>
			...
			<div class="laptop_new clearfix">
				<div class="nd_left">
					<div class="x1">
						...
						<p><a href="#">LAPTOP CHO HỌC SINH / SINH VIÊN</a></p>
						<p><a href="#">LAPTOP CHO LẬP TRÌNH VIÊN</a></p>
						<p><a href="#">LAPTOP CHUYÊN ĐỒ HỌA – GAME</a></p>
						<p><a href="#">LAPTOP DOANH NHÂN</a></p>
						<p><a href="#">LAPTOP ĐỒ HỌA – WORKSTATION</a></p>
						<p><a href="#">LAPTOP GAMING</a></p>
						<p><a href="#">LAPTOP VĂN PHÒNG</a></p>
					</div>
					<div class="x2">
				...
				<div class="nd_right">
					<div class="x4">
							...
							<p>✔ Laptop cũ tại công ty được xách tay nguyên bản 100% chưa qua sửa chữa, Là hàng loại 1 đã qua tuyển chọn từng chiếc ( khi mua máy quý khách hàng sẽ được hướng dẫn check 15 bước để kiểm tra. Tránh mua hàng dựng, hàng qua sửa chữa, hàng loại 2.3 trôi nổi trên thị trường với giá rất rẻ )</p>
							...
							<p>✔ Đối với quý khách hàng ở xa. Khi máy gặp vấn đề quý khách sẽ được hỗ trợ từ xa qua teamview. Zalo. Facebook. Điện thoại… Nếu lỗi phần cứng không khắc phục được, quý khách có thể gửi máy qua bưu điện hoặc nhà xe, công ty sẽ nhận máy, kiểm tra, bảo hành và gửi lại quý khách trong thời gian sớm nhất! Với lần đầu tiên máy lỗi, quý khách chịu tiền cước vận chuyển, nếu lỗi từ lần 2 công ty chịu toàn bộ chi phí vận chuyển hoặc đổi máy mới cho quý khách</p>
						</div>
						<div class="x4">
