...
<head>
	...
	<title>Quản trị viên - Liên hệ</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="admin_contacts.php"><em class="fa fa-clone">&nbsp;</em> Liên hệ</a></li>
                            ...
                            <table>
                                ...
                                <tbody>
                                  ...
                                  <tr>
									...
									<td><span><a href="admin_contact_delete.php?del=<?php echo $se['ID_LH']?>">Delete</a></span></td>
