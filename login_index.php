				...
				<div class="row">
					<div class="banner">
						<ul class="header-top pull-left" style="list-style-type:none;">
							<li><a href="#" target="_blank">Cảm ơn <?php echo $_SESSION['username'] ?> vì đã chọn chúng tôi!!!</a></li>
						</ul>
						<ul class="header-top pull-right" style="list-style-type:none;">
							<li class="lienhe"><a href="logout.php">Đăng xuất</a></li>
							<li>
			...
			<div class="laptop_hot">
				<div class="laptop_hot_home clearfix">
					...
					<div class="laptop_hot_home_r">
						...
						<?php 
							$select5 = $get_data->se_product_top3_des();
