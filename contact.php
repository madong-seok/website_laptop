...
<div class="slide_top">
		<div class="container">
			...
			<div>          
				<div id="">
					<div class="section">
						...
						<form method="post" class="message" >
							<label class="name" >Họ tên :</label></br>
							<input  type="text" class="form1" name="txtname" /></br>
							<label class="name"  >Email :</label></br>
							<input class="form1" type="text" name="txtemail"/></br>
							<label class="name">Tiêu đề :</label></br>
							<input class="form1" type="text" name="txtsubject"/></br>
							<label class="name" >Nội dung :</label></br>
							<textarea class="form" rows="5" cols="50" name="txtcontent"></textarea></br><br>
							<input type="submit" name="sub_send" class="submit" value="Gửi ngay"/>		
						</form>
						<?php 
				...
				<div class="right">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.739794035364!2d105.84483121429746!3d21.003065094032294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac741bff22f3%3A0x3be1db0ed897b596!2zOTJhIFAuIEzDqiBUaGFuaCBOZ2jhu4ssIELDoWNoIEtob2EsIEhhaSBCw6AgVHLGsG5nLCBIw6AgTuG7mWksIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1660063755850!5m2!1svi!2s" width="580" height="440" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
				<div class="clear"></div>
			</div>
		</div>
